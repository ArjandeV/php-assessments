...
class Util_TestDox_NamePrettifierTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals('This is a fileOwnersTest', $this->namePrettifier->prettifyTestMethod('testThisIsATest'));
        $this->assertEquals('This is a fileOwnersTest', $this->namePrettifier->prettifyTestMethod('testThisIsATest2'));
        $this->assertEquals('This is a fileOwnersTest', $this->namePrettifier->prettifyTestMethod('this_is_a_test'));
        ...
        $this->assertEquals('', $this->namePrettifier->prettifyTestMethod('fileOwnersTest'));
    }
