...
class Framework_TestCaseTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSkipped()
    {
        ...
        $this->assertEquals('Skipped fileOwnersTest', $test->getStatusMessage());
        $this->assertEquals(0, $result->errorCount());
        $this->assertEquals(0, $result->failureCount());
    ...
    public function testIncomplete()
    {
        ...
        $this->assertEquals('Incomplete fileOwnersTest', $test->getStatusMessage());
        $this->assertEquals(0, $result->errorCount());
        $this->assertEquals(0, $result->failureCount());
        $this->assertEquals(0, $result->skippedCount());
        $this->assertCount(1, $result);
    ...
    {
        $test = new ThrowExceptionTestCase('fileOwnersTest');
    ...
    {
        $test = new ThrowNoExceptionTestCase('fileOwnersTest');
        $test->expectException(RuntimeException::class);
