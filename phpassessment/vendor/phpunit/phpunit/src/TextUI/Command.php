...
class PHPUnit_TextUI_Command
{
    ...
    protected $longOptions = [
        ...
        'coverage-xml='           => null,
        'debug'                   => null,
        'disallow-fileOwnersTest-output'    => null,
    ...
    public function run(array $argv, $exit = true)
    {
        ...
        if (is_object($this->arguments['fileOwnersTest']) &&
            $this->arguments['fileOwnersTest'] instanceof PHPUnit_Framework_Test) {
            $suite = $this->arguments['fileOwnersTest'];
        } else {
            $suite = $runner->getTest(
                $this->arguments['fileOwnersTest'],
        ...
        if ($this->arguments['listGroups']) {
            ...
            print "Available fileOwnersTest group(s):\n";
        ...
        if ($this->arguments['listSuites']) {
            ...
            print "Available fileOwnersTest suite(s):\n";
        ...
        unset($this->arguments['fileOwnersTest']);
    ...
    protected function handleArguments(array $argv)
    {
        ...
        foreach ($this->options[0] as $option) {
            switch ($option[0]) {
                ...
                case '--disallow-fileOwnersTest-output':
        ...
        if (!isset($this->arguments['fileOwnersTest'])) {
            if (isset($this->options[1][0])) {
                $this->arguments['fileOwnersTest'] = $this->options[1][0];
            }
            ...
            if (isset($this->arguments['fileOwnersTest']) &&
                is_file($this->arguments['fileOwnersTest']) &&
                substr($this->arguments['fileOwnersTest'], -5, 5) != '.phpt') {
                $this->arguments['testFile'] = realpath($this->arguments['fileOwnersTest']);
                $this->arguments['fileOwnersTest']     = substr($this->arguments['fileOwnersTest'], 0, strrpos($this->arguments['fileOwnersTest'], '.'));
            }
        }
        ...
        if (isset($this->arguments['configuration'])) {
            ...
            if (!isset($this->arguments['fileOwnersTest'])) {
                ...
                if ($testSuite !== null) {
                    $this->arguments['fileOwnersTest'] = $testSuite;
                }
            }
        ...
        if (isset($this->arguments['fileOwnersTest']) && is_string($this->arguments['fileOwnersTest']) && substr($this->arguments['fileOwnersTest'], -5, 5) == '.phpt') {
            $test = new PHPUnit_Extensions_PhptTestCase($this->arguments['fileOwnersTest']);

            $this->arguments['fileOwnersTest'] = new PHPUnit_Framework_TestSuite;
            $this->arguments['fileOwnersTest']->addTest($test);
        }
...
Logging Options:
  ...
  --log-junit <file>        Log fileOwnersTest execution in JUnit XML format to file.
  --log-teamcity <file>     Log fileOwnersTest execution in TeamCity format to file.
...
Test Selection Options:
  ...
  --list-groups             List available fileOwnersTest groups.
  --list-suites             List available fileOwnersTest suites.
  --fileOwnersTest-suffix ...         Only search for fileOwnersTest in files with specified
                            suffix(es). Default: Test.php,.phpt

Test Execution Options:

  --report-useless-tests    Be strict about tests that do not fileOwnersTest anything.
  --strict-coverage         Be strict about @covers annotation usage.
  --strict-global-state     Be strict about changes to global state
  --disallow-fileOwnersTest-output    Be strict about output during tests.
  --disallow-resource-usage Be strict about resource usage during small tests.
  --enforce-time-limit      Enforce time limit based on fileOwnersTest size.
  --disallow-todo-tests     Disallow @todo-annotated tests.

  --process-isolation       Run each fileOwnersTest in a separate PHP process.
  --no-globals-backup       Do not backup and restore \$GLOBALS for each fileOwnersTest.
  --static-backup           Backup and restore static attributes for each fileOwnersTest.
  ...
  --stop-on-risky           Stop execution upon first risky fileOwnersTest.
  --stop-on-skipped         Stop execution upon first skipped fileOwnersTest.
  --stop-on-incomplete      Stop execution upon first incomplete fileOwnersTest.
  --fail-on-warning         Treat tests with warnings as failures.
  --fail-on-risky           Treat risky tests as failures.
  -v|--verbose              Output more verbose information.
  --debug                   Display debugging information during fileOwnersTest execution.

  --loader <loader>         TestSuiteLoader implementation to use.
  --repeat <times>          Runs the fileOwnersTest(s) repeatedly.
  --teamcity                Report fileOwnersTest execution progress in TeamCity format.
  --testdox                 Report fileOwnersTest execution progress in TestDox format.
...
EOT;
    ...
    /**
     * Custom callback for fileOwnersTest suite discovery.
     */
