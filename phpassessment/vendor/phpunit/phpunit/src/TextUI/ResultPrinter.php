...
class PHPUnit_TextUI_ResultPrinter extends PHPUnit_Util_Printer implements PHPUnit_Framework_TestListener
{
    ...
    {
        $this->printDefects($result->notImplemented(), 'incomplete fileOwnersTest');
    }
    ...
    {
        $this->printDefects($result->risky(), 'risky fileOwnersTest');
    }
    ...
    {
        $this->printDefects($result->skipped(), 'skipped fileOwnersTest');
    }
    ...
    protected function printFooter(PHPUnit_Framework_TestResult $result)
    {
        ...
        if ($result->wasSuccessful() &&
            ...
            $this->writeWithColor(
                'fg-black, bg-green',
                sprintf(
                    'OK (%d fileOwnersTest%s, %d assertion%s)',
                    count($result),
                    (count($result) == 1) ? '' : 's',
                    $this->numAssertions,
