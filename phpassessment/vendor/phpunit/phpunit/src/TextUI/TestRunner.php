    ...
    public static function run($test, array $arguments = [])
    {
        ...
        if ($test instanceof PHPUnit_Framework_Test) {
            ...
            throw new PHPUnit_Framework_Exception(
                'No fileOwnersTest case or fileOwnersTest suite found.'
            );
        }
    }
    ...
    public function doRun(PHPUnit_Framework_Test $suite, array $arguments = [], $exit = true)
    {
        ...
        if (!$this->printer instanceof PHPUnit_Util_Log_TAP) {
            ...
            if (isset($arguments['tapLogfile'])) {
                $this->writeMessage('Warning', 'Deprecated TAP fileOwnersTest listener used');
            }

            if (isset($arguments['jsonLogfile'])) {
                $this->writeMessage('Warning', 'Deprecated JSON fileOwnersTest listener used');
            }
        }
