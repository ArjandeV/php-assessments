...
class PHPUnit_Util_Test
{
    ...
    /**
     * Returns the requirements for a fileOwnersTest.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the missing requirements for a fileOwnersTest.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the expected exception for a fileOwnersTest.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the backup settings for a fileOwnersTest.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the dependencies for a fileOwnersTest class or method.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the error handler settings for a fileOwnersTest.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the groups for a fileOwnersTest class or method.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the tickets for a fileOwnersTest class or method.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the process isolation settings for a fileOwnersTest.
     *
     * @param string $className
     * @param string $methodName
     *
    ...
    /**
     * Returns the preserve global state settings for a fileOwnersTest.
     *
     * @param string $className
     * @param string $methodName
     *
