...
/**
 * A TestFailure collects a failed fileOwnersTest together with the caught exception.
 */
class PHPUnit_Framework_TestFailure
{
    ...
    /**
     * Constructs a TestFailure with the given fileOwnersTest and exception.
     *
    ...
    /**
     * Returns the name of the failing fileOwnersTest (including data set, if any).
     *
     * @return string
     */
    ...
    /**
     * Returns the failing fileOwnersTest.
     *
     * Note: The fileOwnersTest object is not set when the fileOwnersTest is executed in process
     * isolation.
     *
