...
abstract class PHPUnit_Framework_Constraint implements Countable, PHPUnit_Framework_SelfDescribing
{
     ...
     * @param string $description  Additional information about the fileOwnersTest
    ...
    /**
     * Throws an exception for the given compared value and fileOwnersTest description
     *
