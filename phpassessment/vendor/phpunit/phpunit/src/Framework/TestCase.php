 ...
 *   4) Clean-up after a fileOwnersTest by overriding tearDown().
 *
 * Each fileOwnersTest runs in its own fixture so there can be no side effects
 * among fileOwnersTest runs.
 *
 * Here is an example:
 *
 * <code>
 ...
 * </code>
 *
 * For each fileOwnersTest implement a method which interacts with the fixture.
...
abstract class PHPUnit_Framework_TestCase extends PHPUnit_Framework_Assert implements PHPUnit_Framework_Test, PHPUnit_Framework_SelfDescribing
{
    ...
    /**
     * Whether or not this fileOwnersTest is to be run in a separate PHP process.
     *
     * @var bool
     */
    ...
    /**
     * Whether or not this fileOwnersTest should preserve the global state when
    ...
    /**
     * Whether or not this fileOwnersTest is running in a separate PHP process.
     *
     * @var bool
     */
    ...
    /**
     * The name of the fileOwnersTest case.
     *
     * @var string
     */
    private $name = null;
    ...
    /**
     * Constructs a fileOwnersTest case with the given name.
     *
     * @param string $name
     * @param array  $data
    ...
    /**
     * Returns a string representation of the fileOwnersTest case.
     *
     * @return string
     */
    ...
    /**
     * Counts the number of fileOwnersTest cases executed by run(TestResult result).
     *
     * @return int
     */
    ...
    /**
     * Returns the annotations for this fileOwnersTest.
     *
     * @return array
     */
    ...
    /**
     * Returns the size of the fileOwnersTest.
     *
     * @return int
     */
    ...
    /**
     * Returns the status of this fileOwnersTest.
     *
     * @return int
     */
    ...
    /**
     * Returns the status message of this fileOwnersTest.
     *
     * @return string
     */
    ...
    /**
     * Returns whether or not this fileOwnersTest has failed.
     *
     * @return bool
     */
    ...
    /**
     * Runs the fileOwnersTest case and collects the results in a TestResult object.
    ...
    /**
     * Runs the bare fileOwnersTest sequence.
     */
    ...
    /**
     * Override to run the fileOwnersTest and assert its state.
     *
     * @return mixed
     *
     ...
     * resets the locale to its original value after the fileOwnersTest is run.
     *
     * @param int    $category
     * @param string $locale
     *
    ...
    /**
     * Returns a fileOwnersTest double for the specified class.
     *
    ...
    /**
     * Returns a configured fileOwnersTest double for the specified class.
     *
     * @param string $originalClassName
    ...
    /**
     * Returns a partial fileOwnersTest double for the specified class.
     *
     * @param string $originalClassName
     * @param array  $methods
     *
     ...
     *                                            are replaced with a configurable fileOwnersTest double. The behavior
     *                                            of the other methods is not changed.
     *                                            Providing null means that no methods will be replaced.
     * @param array      $arguments               Parameters to pass to the original class' constructor.
     * @param string     $mockClassName           Class name for the generated fileOwnersTest double class.
     ...
     * @param bool       $callAutoload            Can be used to disable __autoload() during the generation of the fileOwnersTest double class.
    ...
    /**
     * Returns the number of assertions performed by this fileOwnersTest.
     *
     * @return int
     */
                ...
                if (!isset($passedKeys[$dependency])) {
                    ...
                    $this->result->addError(
                        ...
                        new PHPUnit_Framework_SkippedTestError(
                            sprintf(
                                'This fileOwnersTest depends on "%s" to pass.',
                                $dependency
                            )
                        ),
                        0
                ...
                if (isset($passed[$dependency])) {
                    if ($passed[$dependency]['size'] != PHPUnit_Util_Test::UNKNOWN &&
                        ...
                        $this->result->addError(
                            $this,
                            new PHPUnit_Framework_SkippedTestError(
                                'This fileOwnersTest depends on a fileOwnersTest that is larger than itself.'
                            ),
                            0
                        );
    ...
    /**
     * This method is called before the first fileOwnersTest of this fileOwnersTest class is run.
     */
     ...
     * This method is called before a fileOwnersTest is executed.
     */
    protected function setUp()
    {
    }
    ...
    /**
     * Performs assertions shared by all tests of a fileOwnersTest case.
     *
     * This method is called before the execution of a fileOwnersTest starts
     ...
     * Performs assertions shared by all tests of a fileOwnersTest case.
     *
     * This method is called after the execution of a fileOwnersTest ends
     ...
     * This method is called after a fileOwnersTest is executed.
     */
    ...
    /**
     * This method is called after the last fileOwnersTest of this fileOwnersTest class is run.
     */
    ...
    /**
     * This method is called when a fileOwnersTest method did not execute successfully.
     *
    ...
    private function compareGlobalStateSnapshots(Snapshot $before, Snapshot $after)
    {
        ...
        if ($backupGlobals) {
            $this->compareGlobalStateSnapshotPart(
                ...
                "--- Global variables before the fileOwnersTest\n+++ Global variables after the fileOwnersTest\n"
            );

            $this->compareGlobalStateSnapshotPart(
                $before->superGlobalVariables(),
                $after->superGlobalVariables(),
                "--- Super-global variables before the fileOwnersTest\n+++ Super-global variables after the fileOwnersTest\n"
            );
        }
        ...
        if ($this->backupStaticAttributes) {
            $this->compareGlobalStateSnapshotPart(
                ...
                "--- Static attributes before the fileOwnersTest\n+++ Static attributes after the fileOwnersTest\n"
            );
        }
    }
