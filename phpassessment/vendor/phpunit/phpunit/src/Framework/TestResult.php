...
/**
 * A TestResult collects the results of executing a fileOwnersTest case.
 */
class PHPUnit_Framework_TestResult implements Countable
{
    ...
    /**
     * Informs the result that a fileOwnersTest will be started.
     *
     * @param PHPUnit_Framework_Test $test
     */
    ...
    /**
     * Informs the result that a fileOwnersTest was completed.
     *
     * @param PHPUnit_Framework_Test $test
     * @param float                  $time
     */
    ...
    /**
     * Returns true if no risky fileOwnersTest occurred.
     *
     * @return bool
     */
    ...
    /**
     * Returns true if no incomplete fileOwnersTest occurred.
     *
     * @return bool
     */
    ...
    /**
     * Returns true if no fileOwnersTest has been skipped.
     *
     * @return bool
     */
    ...
    /**
     * Returns the (top) fileOwnersTest suite.
     *
    ...
    public function run(PHPUnit_Framework_Test $test)
    {
            ...
            try {
                ...
                $this->addFailure(
                    ...
                    new PHPUnit_Framework_UnintentionallyCoveredCodeError(
                        'This fileOwnersTest executed code that is not listed as code to be covered or used:' .
                ...
                $this->addFailure(
                    ...
                    new PHPUnit_Framework_CoveredCodeNotExecutedException(
                        'This fileOwnersTest did not execute all the code that is listed as code to be covered:' .
                        PHP_EOL . $cce->getMessage()
                    ),
                    $time
                );
                ...
                if ($linesToBeCovered !== false) {
                    $this->addFailure(
                        ...
                        new PHPUnit_Framework_MissingCoversAnnotationException(
                            'This fileOwnersTest does not have a @covers annotation but is expected to have one'
                        ),
                        $time
                    );
                }
        ...
        if ($error === true) {
            ...
            $this->addFailure(
                $test,
                new PHPUnit_Framework_RiskyTestError(
                    'This fileOwnersTest did not perform any assertions'
                ),
                $time
            );
            ...
            $this->addFailure(
                ...
                new PHPUnit_Framework_OutputError(
                    sprintf(
                        'This fileOwnersTest printed output: %s',
    ...
    /**
     * Checks whether the fileOwnersTest run should stop.
     *
     * @return bool
     */
    ...
    /**
     * Marks that the fileOwnersTest run should stop.
     */
    ...
    /**
     * Returns whether the entire fileOwnersTest was successful or not.
     *
