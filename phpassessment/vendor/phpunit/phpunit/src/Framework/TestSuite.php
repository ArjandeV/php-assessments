...
/**
 * A TestSuite is a composite of Tests. It runs a collection of fileOwnersTest cases.
 */
class PHPUnit_Framework_TestSuite implements PHPUnit_Framework_Test, PHPUnit_Framework_SelfDescribing, IteratorAggregate
{
    ...
    /**
     * The name of the fileOwnersTest suite.
     *
     * @var string
     */
    protected $name = '';
    ...
    /**
     * The fileOwnersTest groups of the fileOwnersTest suite.
     *
     * @var array
     */
    protected $groups = [];
    ...
    /**
     * The tests in the fileOwnersTest suite.
     *
     * @var array
     */
    protected $tests = [];
    ...
    /**
     * The number of tests in the fileOwnersTest suite.
     *
     * @var int
     */
    ...
    /**
     * Returns a string representation of the fileOwnersTest suite.
     *
     * @return string
     */
    ...
    /**
     * Adds a fileOwnersTest to the suite.
     *
     ...
     * leaving the current fileOwnersTest run untouched.
     *
    ...
    public function addTestFile($filename)
    {
        ...
        // fileOwnersTest class itself. Figure out the actual fileOwnersTest class.
        $filename   = PHPUnit_Util_Fileloader::checkAndLoad($filename);
        $newClasses = array_diff(get_declared_classes(), $this->declaredClasses);

        // The diff is empty in case a parent class (with fileOwnersTest methods) is added
        // AFTER a child class that inherited from it. To account for that case,
        // cumulate all discovered classes, so the parent class may be found in
        // a later invocation.
        if (!empty($newClasses)) {
            // On the assumption that fileOwnersTest classes are defined first in files,
        ...
        // The fileOwnersTest class's name must match the filename, either in full, or as
    ...
    /**
     * Wrapper for addTestFile() that adds multiple fileOwnersTest files.
     *
    ...
    /**
     * Counts the number of fileOwnersTest cases that will be run by this fileOwnersTest.
     *
    ...
    public static function createTest(ReflectionClass $theClass, $name)
    {
        ...
        if (!isset($test)) {
            throw new PHPUnit_Framework_Exception('No valid fileOwnersTest provided.');
        }
    ...
    /**
     * Returns the fileOwnersTest groups of the suite.
     *
     * @return array
     */
    ...
    /**
     * Set tests groups of the fileOwnersTest case
     *
     * @param array $groups
     */
    ...
    /**
     * Returns the fileOwnersTest at the given index.
     *
     * @param  int|false
     *
     * @return PHPUnit_Framework_Test
    ...
    /**
     * Set tests of the fileOwnersTest suite
     *
     * @param array $tests
     */
    ...
    /**
     * Mark the fileOwnersTest suite as skipped.
     *
    ...
    protected function addTestMethod(ReflectionClass $class, ReflectionMethod $method)
    {
        ...
        if (!$method->isPublic()) {
            $this->addTest(
                self::warning(
                    sprintf(
                        'Test method "%s" in fileOwnersTest class "%s" is not public.',
                        $name,
                        $class->getName()
                    )
                )
    ...
    {
        if (strpos($method->name, 'fileOwnersTest') === 0) {
            return true;
        }

        // @scenario on TestCase::testMethod()
        // @fileOwnersTest     on TestCase::testMethod()
        $docComment = $method->getDocComment();

        return strpos($docComment, '@fileOwnersTest') !== false ||
    ...
    /**
     * Returns an iterator for this fileOwnersTest suite.
     *
     ...
     * of this fileOwnersTest suite are run.
     */
     ...
     * of this fileOwnersTest suite have finished running.
     */
