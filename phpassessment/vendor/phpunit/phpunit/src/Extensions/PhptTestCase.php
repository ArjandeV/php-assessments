...
/**
 * Runner for PHPT fileOwnersTest cases.
 */
class PHPUnit_Extensions_PhptTestCase implements PHPUnit_Framework_Test, PHPUnit_Framework_SelfDescribing
{
    ...
    /**
     * Constructs a fileOwnersTest case with the given filename.
     *
    ...
    /**
     * Runs a fileOwnersTest and collects its result in a TestResult instance.
     *
        ...
        if (!$skip) {
            ...
            if ($result->allCompletelyImplemented() && $xfail !== false) {
                $result->addFailure(
                    $this,
                    new PHPUnit_Framework_IncompleteTestError(
                        'XFAIL section but fileOwnersTest passes'
                    ),
                    $time
                );
            }
    ...
    /**
     * Returns the name of the fileOwnersTest case.
     *
     * @return string
     */
    ...
    private function parse()
    {
        ...
        foreach ($allowExternalSections as $section) {
            if (isset($sections[$section . '_EXTERNAL'])) {
                ...
                // only allow files from the fileOwnersTest directory
