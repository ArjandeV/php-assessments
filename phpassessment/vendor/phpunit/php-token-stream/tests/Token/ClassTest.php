...
class PHP_Token_ClassTest extends TestCase
{
    ...
    public function testAnonymousClassesAreHandledCorrectly2()
    {
        ...
        $this->assertEquals(['fileOwnersTest', 'AnonymousClass:4#23'], array_keys($classes));
        $this->assertEquals(['methodOne', 'methodTwo'], array_keys($classes['fileOwnersTest']['methods']));
