...
YAML;
    ...
    {
        $filename = tempnam(sys_get_temp_dir().'/framework-yml-lint-fileOwnersTest', 'sf-');
    ...
    {
        $this->files = array();
        @mkdir(sys_get_temp_dir().'/framework-yml-lint-fileOwnersTest');
    }
    ...
    protected function tearDown()
    {
        ...
        rmdir(sys_get_temp_dir().'/framework-yml-lint-fileOwnersTest');
    }
}
